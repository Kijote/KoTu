...
$test = array(
		'PHP Version' => array(
								'test' => (version_compare(PHP_VERSION, '5.3.3', '>=')),
								'pass' => PHP_VERSION,
								'fail' => 'PHP 5.3.3 or newer, this version is ' . PHP_VERSION),
		'System Directory' => array(
								'test' => (is_dir(SYSPATH) AND is_file(SYSPATH.'classes/Kohana'.EXT)),
								'pass' => SYSPATH,
								'fail' => 'The configured <code>system</code> directory does not exist or does not contain required files. Check permissions!'),
		'Application Directory' => array(
								'test' => (is_dir(APPPATH) AND is_file(APPPATH.'bootstrap'.EXT)),
								'pass' => APPPATH,
								'fail' => 'The configured <code>application</code> directory does not exist or does not contain required files. Check permissions!'),
		'Cache Directory' => array(
								'test' => (is_dir(APPPATH) AND is_dir(APPPATH.'cache') AND is_writable(APPPATH.'cache')),
								'pass' => APPPATH.'cache/',
								'fail' => 'The <code>' . APPPATH . 'logs/</code> directory is not writable.'),
		'Logs Directory' => array(
								'test' => (is_dir(APPPATH) AND is_dir(APPPATH.'logs') AND is_writable(APPPATH.'logs')),
								'pass' => APPPATH.'logs/',
								'fail' => 'The <code>' . APPPATH . 'logs/</code> directory is not writable.'),
		'PCRE UTF-8' => array(
								'test' => (@preg_match('/^.$/u', 'ñ')),
								'pass' => 'PCRE UTF-8 supported',
								'fail' => '<a href="http://php.net/pcre">PCRE</a> has not been compiled with UTF-8 support.'),
		'PCRE Unicode' => array(
								'test' => (@preg_match('/^\pL$/u', 'ñ')),
								'pass' => 'PCRE Unicode supported',
								'fail' => '<a href="http://php.net/pcre">PCRE</a> has not been compiled with Unicode support.'),
		'SPL Enabled' => array(
								'test' => (function_exists('spl_autoload_register')),
								'pass' => 'SPL Enabled',
								'fail' => 'PHP <a href="http://www.php.net/spl">SPL</a> is either not loaded or not compiled in.'),
		'Reflection Enabled' => array(
								'test' => (class_exists('ReflectionClass')),
								'pass' => 'Reflection Enabled',
								'fail' => 'PHP <a href="http://www.php.net/reflection">reflection</a> is either not loaded or not compiled in.'),
		'Iconv Extension Loaded' => array(
								'test' => (extension_loaded('iconv')),
								'pass' => 'Iconv Extension Loaded',
								'fail' => 'The <a href="http://php.net/iconv">iconv</a> extension is not loaded.'),
);
...
<body>
	...
	<table cellspacing="0">
		...
		<tr>
			...
			<?php else: $failed = TRUE ?>
				<td class="fail">The configured <code>system</code> directory does not exist or does not contain required files. Permission Denied?</td>
			<?php endif ?>
		</tr>
		<tr>
			...
			<?php else: $failed = TRUE ?>
				<td class="fail">The configured <code>application</code> directory does not exist or does not contain required files. Permission Denied?</td>
			<?php endif ?>
		</tr>
		<tr>
